...
Target (Cloudflare Pages vs. Workers Static Assets) is decided at deploy time;
the build output (`build/client`) is portable between them. See
`plans/svdsa-static-rebuild.md` for the current plan and decisions.
